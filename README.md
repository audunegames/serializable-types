...
* [UnityEditor Utilities](https://openupm.com/packages/com.audune.utils.unityeditor/), version **2.0.0** or higher.
...
```
https://github.com/audunegames/serializabletypes.git
```
